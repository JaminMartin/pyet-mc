...
- [Generating a structure & plotting](./structures/structure_creation_and_plotting.md)
- [Energy transfer models](./structures/energy_transfer_models.md)
   - [Modelling energy transfer processes](./structures/modelling_energy_transfer.md)
   - [Adding your own interaction model](./structures/adding_interaction_models.md)
...
- [Fitting experimental data to energy transfer models](./fitting/fitting.md)
   ...
   - [Fitting Algorithms](./fitting/fitting_algorithms.md)
